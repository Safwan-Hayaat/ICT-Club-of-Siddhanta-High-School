const easyQuestions = [
    ...
    { q: "What happens when you press 'Ctrl + Z' on a keyboard?", ans: "Undo", wrong: ["Save"] },
...
const mediumQuestions = [
    ...
    { q: "What is the smooth cut between two clips in video editing called?", ans: "Transition", wrong: ["Keyframe", "Render"] },
    ...
    { q: "What is Git used for?", ans: "Version control and code management", wrong: ["Video editing and video rendering", "Image editing and art"] },
...
const hardQuestions = [
    ...
    { q: "What is a 'Deadlock' in an operating system?", ans: "Two or more processes waiting indefinitely for each other's resources", wrong: ["Computer crashing due to heat", "Forgetting the password", "A hard disk failure due to unoptimised"] },
